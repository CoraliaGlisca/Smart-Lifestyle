var ChatBot = function () {
    ...
    return {
        Engines: {
            ...
            spoonacular: function (apiKey = '061ae7be95124e3a8d22ce08d7d628c9') {
                ...
                return {
                    react: function (query) {
                        $.get("https://api.spoonacular.com/food/converse?apiKey=" + apiKey + "&contextId=" + contextId +"&text=" + encodeURIComponent(query),
                            function (data)
                            {
